...
public class ChampionTest {
    ...
    @Test
    public void givenCollectionWhemEmptyCorrect() {
    ...
    public void 서폿챔피언은타릭이어야한다() {
        Champion supportChap = new Champion("타릭", "바텀");
        assertThat("타릭", is(supportChap.getName()));
        assertThat("타릭", is(equalTo(supportChap.getName())));
        assertThat("타릭", equalTo(supportChap.getName()));
    }
